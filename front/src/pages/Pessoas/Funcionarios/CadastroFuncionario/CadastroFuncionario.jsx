...
/**
 * Componente para cadastro de novos funcionários
 * @component
 * @returns {JSX.Element} Formulário de cadastro de funcionário
 */
function CadastroFuncionario() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Requisição POST para criar novo funcionário
  ...
  /**
   * Renderiza o formulário de cadastro de funcionário
   */
  return (
